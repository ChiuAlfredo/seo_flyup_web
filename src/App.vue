        ...
        <div class="flex justify-between h-16">
          <div class="flex items-center">
            ...
            <div class="hidden sm:ml-8 sm:flex sm:items-center sm:space-x-8">
              ...
              <!-- Services Dropdown -->
              <div class="relative" @mouseleave="isServicesDropdownOpen = false">
                <span class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-900 hover:text-indigo-600 border-b-2 border-transparent hover:border-indigo-600 group" active-class="text-indigo-600 border-indigo-600" @mouseover="isServicesDropdownOpen = true">
                  服務項目
                ...
                <div v-if="isServicesDropdownOpen" class="absolute z-10 left-0 mt-1 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1">
